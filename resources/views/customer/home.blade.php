    ...
    <div class="container">
        <div class="row align-items-center min-vh-75">
            ...
            <div class="col-lg-6 text-center">
                <img src="{{ asset('images/hero-milktea.png') }}" alt="Milk Tea" class="img-fluid hero-image" 
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-3">
                <a href="{{ route('products.index', ['category' => $key]) }}" class="text-decoration-none">
                    <div class="card category-card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            <div class="category-icon mb-3">
                                @if($key == 'milk_tea')
                                    <i class="bi bi-cup-straw fs-1 text-primary"></i>
                                @elseif($key == 'fruit_tea')
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <div class="card product-card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <span class="badge bg-secondary mb-2">{{ $product->category_label }}</span>
