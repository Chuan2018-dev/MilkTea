                    ...
                    <div class="card-header bg-white py-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                ...
                                <p class="mb-0 fw-bold text-primary">{{ $order->formatted_total }}</p>
                            </div>
                            <div class="col-md-2">
                                <span class="text-muted small">Status</span>
                                <span class="badge {{ $order->status_badge_class }} d-block w-100">
                                    {{ $order->status_label }}
                                </span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <p class="text-muted mb-1">
                                    <i class="bi bi-geo-alt me-2"></i>{{ Str::limit($order->delivery_address, 60) }}
                                </p>
                                <p class="text-muted mb-0">
                                    <i class="bi bi-credit-card me-2"></i>{{ ucfirst($order->payment_method) }}
                                    <span class="badge {{ $order->payment_status_badge_class }} ms-2">
