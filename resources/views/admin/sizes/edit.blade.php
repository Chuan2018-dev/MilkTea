...
@section('title', 'Edit Size - Admin - Milk Tea Shop')
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 ms-sm-auto px-md-4 py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-4 border-bottom">
                <h1 class="h2"><i class="bi bi-pencil me-2"></i>Edit Size</h1>
                <a href="{{ route('admin.sizes.index') }}" class="btn btn-outline-secondary">
                    <i class="bi bi-arrow-left me-2"></i>Back to Sizes
                </a>
            </div>
                    ...
                    <form action="{{ route('admin.sizes.update', $size) }}" method="POST">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="{{ old('price_adjustment', $size->price_adjustment) }}" 
                                           step="0.01"
                                           required>
                                </div>
                                <small class="text-muted">Use negative for discount, positive for extra charge</small>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-2"></i>Update Size
                            </button>
                            <a href="{{ route('admin.sizes.index') }}" class="btn btn-outline-secondary">
                                Cancel
                            </a>
