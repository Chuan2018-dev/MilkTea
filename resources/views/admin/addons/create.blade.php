...
@section('title', 'Add Add-on - Admin - Milk Tea Shop')
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 ms-sm-auto px-md-4 py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-4 border-bottom">
                <h1 class="h2"><i class="bi bi-plus-lg me-2"></i>Add Add-on</h1>
                    ...
                    <form action="{{ route('admin.addons.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg me-2"></i>Create Add-on
                            </button>
                            <a href="{{ route('admin.addons.index') }}" class="btn btn-outline-secondary">
                                Cancel
                            </a>
