...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.products.index', $returnQuery) }}" class="btn btn-outline-secondary">
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ route('admin.products.update', array_merge(['product' => $product], $returnQuery)) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                ...
                                <div class="col-4">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="size_{{ $size }}" {{ in_array($size, old('available_sizes', $product->available_sizes ?? ['small', 'medium', 'large'])) ? 'checked' : '' }}>
                                ...
                                <div class="col">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="sugar_{{ str_replace('%', '', $sugar) }}" {{ in_array($sugar, old('available_sugar_levels', $product->available_sugar_levels ?? ['0%', '30%', '50%', '70%', '100%'])) ? 'checked' : '' }}>
                                ...
                                <div class="col-3">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="ice_{{ $ice }}" {{ in_array($ice, old('available_ice_levels', $product->available_ice_levels ?? ['no_ice', 'less', 'regular', 'extra'])) ? 'checked' : '' }}>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('admin.products.index', $returnQuery) }}" class="btn btn-outline-secondary btn-lg">
                    Cancel
                </a>
            </div>
        </form>
