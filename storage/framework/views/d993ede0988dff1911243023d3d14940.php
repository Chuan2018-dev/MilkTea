...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <span class="text-muted"><?php echo e(now()->format('l, F d, Y')); ?></span>
</div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h3 class="mb-0"><?php echo e($todayOrders); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h3 class="mb-0"><?php echo e($pendingOrders); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h3 class="mb-0">$<?php echo e(number_format($todayRevenue, 2)); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h3 class="mb-0"><?php echo e($activeProducts); ?>/<?php echo e($totalProducts); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="<?php echo e(route('admin.addons.create')); ?>" class="btn btn-outline-success">
                    ...
                    <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn btn-outline-info">
                ...
                <div class="list-group list-group-flush">
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                        ...
                        <span class="badge bg-primary rounded-pill"><?php echo e($totalOrders); ?></span>
                    </div>
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <span>Total Customers</span>
                        <span class="badge bg-success rounded-pill"><?php echo e($totalCustomers); ?></span>
                    </div>
                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <span>Monthly Revenue</span>
                        <span class="badge bg-info rounded-pill">$<?php echo e(number_format($monthRevenue, 2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
const weeklySalesChart = new Chart(weeklySalesCtx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode(collect($weeklySales)->pluck('day')); ?>,
        datasets: [{
            label: 'Sales ($)',
            data: <?php echo json_encode(collect($weeklySales)->pluck('sales')); ?>,
            borderColor: '#0d6efd',
...
const ordersStatusChart = new Chart(ordersStatusCtx, {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode(array_keys($ordersByStatus)); ?>,
        datasets: [{
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Kimi_Agent\milk-tea-shop\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>