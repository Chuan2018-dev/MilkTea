...
unset($__errorArgs, $__bag); ?>" 
                                           id="base_price" name="base_price" value="<?php echo e(old('base_price')); ?>" required>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="size_<?php echo e($size); ?>" <?php echo e(in_array($size, old('available_sizes', ['small', 'medium', 'large'])) ? 'checked' : ''); ?>>
                                ...
                                <div class="col">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="sugar_<?php echo e(str_replace('%', '', $sugar)); ?>" <?php echo e(in_array($sugar, old('available_sugar_levels', ['0%', '30%', '50%', '70%', '100%'])) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-3">
                                    <div class="form-check border rounded p-3">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="ice_<?php echo e($ice); ?>" <?php echo e(in_array($ice, old('available_ice_levels', ['no_ice', 'less', 'regular', 'extra'])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <img id="imagePreview" src="<?php echo e(asset('images/default-product.svg')); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Kimi_Agent\milk-tea-shop\resources\views\admin\products\create.blade.php ENDPATH**/ ?>